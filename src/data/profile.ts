...
export const profile = {
  ...
  intro: [
    ...
    [
      ...
      '입니다. 그래서 제 생각이 상대에게 얼마나 잘 전달될 수 있을까를 늘 고민하고 상대의 의도를 끝까지 확인하려는 습관을 가지고 있습니다. 이 습관 덕분에, 팀 프로젝트에서 아키텍처 방향을 두고 동료와 의견이 갈렸을 때도 동료가 반대하는 이유를 구체적으로 확인한 뒤, 그 우려를 해소할 대응 방안을 회의에서 설명하며 설득할 수 있었습니다. 그 결과 동료도 동의해 같은 방향으로 나아갈 수 있었습니다.',
    ],
  ] as IntroParagraph[],
