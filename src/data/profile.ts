  ...
  intro: [
    {
      segments: [
        '저는 ',
        { bold: "'왜 이렇게 만들어야 하는가'를 끝까지 파고드는 사람" },
        '입니다. 그래서 문제 정의와 설계 과정에는 시간을 아끼지 않고, 그 의도를 스스로 설명해왔습니다. 예를 들어 팀 프로젝트에서 결제 게이트웨이 장애가 서비스 전체로 번지지 않도록 여러 안전장치를 설계할 때, 왜 이 장치가 필요한지와 왜 이런 구조를 선택해야 하는지를 꼼꼼히 파고들어 설계했습니다. 그 덕분에 구현 의도를 코드 리뷰에서 명확히 설명할 수 있었고, 팀으로부터 의도에 맞게 잘 작성했다는 평가를 받았습니다.',
      ],
      link: '/projects/ai-prompt-marketplace/troubleshooting/toss-payment-resilience-layers/',
      linkLabel: '문서 보기 ↗',
    },
    [
      '또한 제 생각이 상대에게 얼마나 잘 전달되는지 늘 점검하고, ',
      { bold: '소통 방식을 계속 다듬어가는 사람' },
      '입니다. 그래서 의견을 전달할 때도 상대의 의도를 끝까지 확인하는 습관을 들이고 있습니다. 이 습관 덕분에, 팀 프로젝트에서 아키텍처 방향을 두고 동료와 의견이 갈렸을 때도 동료가 반대하는 이유를 구체적으로 확인한 뒤 그 우려에 맞춘 대안을 회의에서 설명하며 설득할 수 있었습니다. 그 결과 동료도 동의해 함께 방향을 정할 수 있었습니다.',
    ],
  ] as IntroParagraph[],
