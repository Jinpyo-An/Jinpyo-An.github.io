...
export const profile = {
  ...
  intro: [
    'AI 시대에는 구현 자체의 가치보다 무엇을 만들지 정의하고 설계하는 능력이 개발자의 핵심 역량이라고 생각합니다. 그래서 문제 정의와 설계 과정에는 시간을 아끼지 않고, 구현 후에도 결과물을 꼼꼼히 검증하며 그 의도를 스스로 설명할 수 있어야 한다고 믿습니다. 구현은 누구나 할 수 있는 시대이지만, 왜 그렇게 구현했는지 설명할 수 있는 사람은 드물기 때문입니다.',
